 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
                    ...
                    slideChange: function() {
                        ...
                        function choice(e) {
                            ...
                            if (target.closest(".swiper-slide-active") && !target.closest(".slider-main__choice")) {
                                ...
                                if (activeSlide.closest("._choice-active")) links.forEach((link => {
            ...
            if (document.querySelector(".slider-autopark__slider")) {
                let autoparkSlider = new core(".slider-autopark__slider", {
                    ...
                    button.addEventListener("click", (function() {
                        ...
                        if (button.classList.contains("_active-filter")) {
                            ...
                            autoparkSlides.forEach((slide => {
                                if (slide.classList.contains(`slider-autopark_${buttonData}`)) sliderWrapper.append(slide);
                            }));
            ...
            if (document.querySelector(".slider-small-reviews__slider") && document.querySelector(".slider-big-reviews__slider")) {
                let smallReviewsSlider = new core(".slider-small-reviews__slider", {
                ...
                let bigReviewsSlider = new core(".slider-big-reviews__slider", {
                    modules: [ Navigation, Pagination, Controller ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        if (searchBurger) {
            ...
            document.addEventListener("click", (function(e) {
                let target = e.target;
                if (!target.closest(".search-main")) searchMain.classList.remove("search-open");
            }));
        }
        const rentTypeColumns = document.querySelectorAll(".rent-type__column");
        document.querySelectorAll(".rent-type__button");
        rentTypeColumns.forEach((column => {
            const item = column.querySelector(".rent-type__item");
            item.querySelector(".rent-type__scroll-arrow");
            item.addEventListener("click", itemScroll);
            itemScroll();
            function itemScroll() {
                setTimeout((() => {
                    if (item.scrollHeight > item.clientHeight && !item.classList.contains("_scroll-item")) item.classList.add("_scroll-item");
                    if (item.scrollHeight === item.clientHeight && item.classList.contains("_scroll-item")) item.classList.remove("_scroll-item");
                }), 500);
            }
            item.addEventListener("scroll", (function() {
                if (item.scrollTop > 20 && !item.classList.contains("_arrow-up")) item.classList.add("_arrow-up");
                if (item.scrollTop < 20 && item.classList.contains("_arrow-up")) item.classList.remove("_arrow-up");
            ...
            column.addEventListener("click", (function(e) {
                if (e.target.closest(".rent-type__button")) {
                    ...
                    if (item.scrollHeight > item.clientHeight) item.scrollTo({
                        top: item.scrollHeight,
                        behavior: "smooth"
                    });
                    rentTypeColumns.forEach((columnOth => {
                        if (columnOth !== column) columnOth.classList.remove("_rent-type_active");
                    }));
                }
                if (e.target.closest(".rent-type__item") && !e.target.closest("button")) column.classList.toggle("_rent-type_active");
                if (e.target.closest(".rent-type__scroll-arrow-down")) item.scrollTo({
                    top: item.scrollHeight,
                    behavior: "smooth"
                });
                if (e.target.closest(".rent-type__scroll-arrow-up")) item.scrollTo({
                    top: 0,
                    behavior: "smooth"
                });
            }));
        ...
        function initMap() {
            ...
            const mapMatchMedia1200 = window.matchMedia("(max-width: 1200px)"), mapMatchMedia768 = window.matchMedia("(max-width: 768px)"), mapMatchMedia480 = window.matchMedia("(max-width: 480px)"), mapMatchMediaMore1201 = window.matchMedia("(min-width: 1201px)");
